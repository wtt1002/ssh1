...
<BODY>
	<FORM id=form1 name=form1
		action="${pageContext.request.contextPath }/student_update.action"
		method=post>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<TR>
								...
								<td>
									<select style="WIDTH: 100px" maxLength=80 name="rollYear" id="rollYear">
											<option value=value="${model.rollYear }">${model.rollYear }</option>
									</select>
								</td>
							</TR>
							...
							<TR>
								...
								<td>
									<select style="WIDTH: 100px" maxLength=80 name="clazzId" id="clazzName">
											<option value="${model.clazzId }">${model.clazzId }</option>
									</select>
								</td>
								<td>学生姓名：</td>
								<td>
								<INPUT class=textbox id=sChannel2 
														style="WIDTH: 180px" maxLength=50 name="studentName" value="${model.studentName }">
							...
							<TR>
								...
								<INPUT class=textbox id=sChannel2 readonly="readonly"
														style="WIDTH: 180px" maxLength=50 name="studentId" value="${model.studentId }">
								</td>
								<td>登录密码 ：</td>
								<td>
								<INPUT class=textbox id=sChannel2
