...
<BODY>
	<FORM id=form1 name=form1
		action="${pageContext.request.contextPath }/teacher_update.action"
		method=post>
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：教师管理 &gt; 修改教师</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<TR>
								...
								<td>
									<INPUT class=textbox id=sChannel2 
														style="WIDTH: 180px" maxLength=50 name="rollYear" value="${model.rollYear }">
								</td>
							</TR>
							...
							<TR>
								...
								<td>
								<INPUT class=textbox id=sChannel2 
														style="WIDTH: 180px" maxLength=50 name="teacherName" value="${model.teacherName }">
							...
							<TR>
								...
								<INPUT class=textbox id=sChannel2 readonly="readonly"
														style="WIDTH: 180px" maxLength=50 name="teacherId" value="${model.teacherId }">
								</td>
								<td>登录密码 ：</td>
								<td>
								<INPUT class=textbox id=sChannel2
														style="WIDTH: 180px" maxLength=50 name="password" value="${model.password }">
								</td>
							</TR>
							<TR>
